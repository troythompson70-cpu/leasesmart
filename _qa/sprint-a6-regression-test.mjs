...
assert('A6 build id', buildMatch && /^20260526-v2\.(3\.0-e1|4\.0-a7)$|^20260527-v2\.(4\.0-a7|5\.0-a8)$|^20260528-v2\.(7\.0-auth1|8\.0-newark)$|^20260529-v2\.(9\.0-actionpanel|10\.0-frontpage)$|^20260530-v2\.11\.0-c1pro$/.test(buildMatch[1]));
