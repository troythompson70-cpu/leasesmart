...
assert('D2 build id', html.includes("LS_BUILD = '20260526-v2.1.0-e2'") || html.includes("LS_BUILD = '20260526-v2.0.0-d3'") || html.includes("LS_BUILD = '20260526-v1.9.0-d5'") || html.includes("LS_BUILD = '20260526-v1.8.0-d4'") || html.includes("LS_BUILD = '20260526-v1.6.0-d2'"));
